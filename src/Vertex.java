...
/**
 * This has been slightly modified by THOMAS CARNEY for ICS 340 program 2. A goal
 * member and getter/setter functions were added. A minPathCost was also added
...
class Vertex<T> {
  ...
  /**
   * This method is used to state whether this vertex is a goal or not.
   * 
   * @param newGoal - A boolean variable stating whether the vertex is
   * a goal or not.
   */
  ...
  /**
   * This method allow you to get the shortest path cost currently known.
   * 
   * @return - The shortest path cost currently known.
   */
  ...
  /**
   * This method allow you to set the shortest path cost currently known.
   * 
   * @return - The shortest path cost currently known.
   */
